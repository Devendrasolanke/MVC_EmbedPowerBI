...
namespace AppOwnsData.Services
{
    ...
    public class ConfigValidatorService
    {
        ...
        public static readonly Guid ReportId = GetParamGuid(ConfigurationManager.AppSettings["reportIdSales"]);
        public static readonly Guid ReportIdService = GetParamGuid(ConfigurationManager.AppSettings["reportIdService"]);
        ...
        public static string GetWebConfigErrors()
        {
            ...
            else if (ReportIdService == Guid.Empty)
            {
                message = "ReportId is empty or not a valid Guid. Please fill its Id correctly in web.config";
            }
